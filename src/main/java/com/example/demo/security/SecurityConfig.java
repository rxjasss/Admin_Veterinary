...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests((requests) -> requests
                ...
                .permitAll().requestMatchers("/users/listUsers","/listUsers","/users/formUser/**","/users/formUser","/deleteUser/**","/activateUser/**","/addUser","/addVeterinary","/formPasswordUser/**").hasAuthority("ROLE_ADMIN").anyRequest()
                .authenticated())
